...
function createFaviconSvg(size, color, textColor, symbol, font, cssWeight) {
  if (size < 10) {
...
async function generateFavicons(siteVariables, distDir) {
...
module.exports = { generateFavicons, createFaviconSvg };
